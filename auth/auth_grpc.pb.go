...
const (
	...
	AuthService_Jscode2Session_FullMethodName        = "/auth.AuthService/jscode2session"
)
...
func _AuthService_Jscode2Session_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AuthServiceServer).Jscode2Session(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_Jscode2Session_Handler,
		},
	},
